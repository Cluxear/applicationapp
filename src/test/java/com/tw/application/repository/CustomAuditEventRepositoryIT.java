...
import com.tw.application.config.audit.AuditEventConverter;
import com.tw.application.domain.PersistentAuditEvent;
...
import static com.tw.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
